...
class WifiProtectionViewController: UIViewController {
	...
	private func setupComponents() {
		...
		notes.text = NSLocalizedString("**This feature is EXPERIMENTAL, as such, it may not work as expected in some instances. \n\n**Mobile Safari has performance issues with the PAC config, so it is recommended you use Cliqz, Ghostery or another Browser instead.", tableName: "Cliqz", comment:"[WiFi Protection] Notes")
