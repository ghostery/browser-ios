...
fileprivate class DarkTableViewColor: TableViewColor {
    override var headerTextDark: UIColor { return UIColor.white }
}
...
fileprivate class DarkURLBarColor: URLBarColor {
    ...
    override var pageOptionsUnselected: UIColor { return UIColor.black }
}
...
fileprivate class DarkGeneralColor: GeneralColor {
    ...
    override var controlTint: UIColor { return UIColor.white }
}

class CliqzDarkTheme: NormalTheme {
